...
export default props => (
		<div className={ `Share `
			...
			<a className="Share__iconwrapper twitter" href={`https://twitter.com/intent/tweet?text=${ props.title } by Mauricio De La Quintana(@maudelaquintana) ${ props.url}` }  target="_blank" rel="noopener noreferrer" data-size="large">
			...
			<a className="Share__iconwrapper facebook" href={`https://www.facebook.com/sharer/sharer.php?
				...
				title={ props.title }
				>
					<img alt="img" className="Share__icon" title="Compartir en Facebook" src="https://icongr.am/fontawesome/facebook.svg?color=ffffff"
				/>
			</a>
			<a className="Share__iconwrapper linkedin" href={
				...
				target="_blank"
				rel="noopener noreferrer">
				<img alt="img" className="Share__icon" title="Compartir en Linkedin" src="https://icongr.am/fontawesome/linkedin.svg?color=ffffff"
				/>
			</a>
	</div>
)